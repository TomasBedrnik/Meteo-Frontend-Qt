...
Rectangle{
    ...
    function nextRadar() {
        var nGraphs = 12;
        var d = new Date;
        var dateAct = new Date(d.getTime() - (nGraphs - radarImageIter)*600000 - 600000)
        var date = new Date(d.getTime() + d.getTimezoneOffset()*60000 - (nGraphs - radarImageIter)*600000 - 600000)
